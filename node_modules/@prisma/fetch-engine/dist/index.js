...
__export(dist_exports, {
  ...
  download: () => import_chunk_5HVOI32H.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_5HVOI32H.getBinaryName,
  getCacheDir: () => import_chunk_5T2KHPZI.getCacheDir,
  getProxyAgent: () => import_chunk_RJCNBAHR.getProxyAgent,
  getVersion: () => import_chunk_5HVOI32H.getVersion,
  maybeCopyToTmp: () => import_chunk_5HVOI32H.maybeCopyToTmp,
  overwriteFile: () => import_chunk_5T2KHPZI.overwriteFile,
  plusX: () => import_chunk_5HVOI32H.plusX,
  vercelPkgPathRegex: () => import_chunk_5HVOI32H.vercelPkgPathRegex
});
module.exports = __toCommonJS(dist_exports);
var import_chunk_5HVOI32H = require("./chunk-5HVOI32H.js");
