...
var Tracks = /** @class */ (function (_super) {
    ...
    function Tracks() {
         ...
         */
        _this.getV2 = function (trackResolvable) { return __awaiter(_this, void 0, void 0, function () {
            var trackID, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sc.resolve.getV2(trackResolvable)];
                    case 1:
                        trackID = _a.sent();
         ...
         */
        _this.relatedV2 = function (trackResolvable, limit) { return __awaiter(_this, void 0, void 0, function () {
            var trackID, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sc.resolve.getV2(trackResolvable)];
